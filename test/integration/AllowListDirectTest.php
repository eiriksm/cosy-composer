...
/**
 * Test for allow list with direct dependencies.
 */
class AllowListDirectTest extends ComposerUpdateIntegrationBase
{
    protected ?string $composerAssetFiles = 'composer.always_allow_direct_dependencies';
