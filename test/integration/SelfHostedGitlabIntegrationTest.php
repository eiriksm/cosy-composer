...
class SelfHostedGitlabIntegrationTest extends ComposerUpdateIntegrationBase
{
    ...
    public function testUpdateToken()
    {
        ...
        $this->cosy->setUrl('https://acme.gitlab.com/user/repo');
    ...
    protected function handleExecutorReturnCallback($cmd, &$return)
    {
        ...
        if (strpos($command_string, 'https://oauth2:verysecret@acme.gitlab.com/user/repo') !== false) {
